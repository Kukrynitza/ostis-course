...
import { langToKeynode, snakeToCamelCase, useBooleanState, useLanguage, Popup, Spinner } from 'ostis-ui-lib';
...
export const Scg: FC<IProps> = ({ action, className, show = false }) => {
  ...
  return (
    <>
      ...
      <div className={classNames(styles.wrap, { [styles.wrap_visible]: show, [styles.wrap_hidden]: !show }, className)}>
        {isLoading && <div className={styles.spinner}><Spinner appearance="#5896C0" /></div>}
