...
ScKeynodes.prototype.resolveKeynode = async function (sys_idtf, property) {
  ...
  // ostis-course 90e7c0b (Kukrynitza): не ронять инициализацию SCg, если keynodes
  // кратковременно недоступны; иначе iframe не шлёт onInitializationFinished / renderScg.
  const MAX_RETRIES = 3;
  let attempts = 0;
